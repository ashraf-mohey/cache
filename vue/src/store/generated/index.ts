...
import AshrafMoheyCacheAshrafmoheyCacheEhr from './ashraf-mohey/cache/ashrafmohey.cache.ehr'
...
export default { 
  AshrafMoheyCacheAshrafmoheyCacheEhr: load(AshrafMoheyCacheAshrafmoheyCacheEhr, 'ashrafmohey.cache.ehr'),
